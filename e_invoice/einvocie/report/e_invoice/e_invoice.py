...
def get_columns(filters):
	columns = [
		...
		{
			"label": _("Purchase Order Reference"),
			"fieldname": "po_no",
			"fieldtype": "Data",
			"width": 100
		},
		{
			"label": _("purchaseOrderDescription"),
			"fieldname": "po_descroption",
			"fieldtype": "Data",
			"width": 100
		},
		]
...
def get_data(filters) :
	...
	main_sql = """ 
		SELECT  `tabCustomer`.customer_name AS receivername ,
				...
				`tabSales Invoice`.po_descroption as po_descroption , 
	...
	for i in main_data :
		c = frappe.db.sql(""" 
		SELECT 
			itemcode,item_name ,description ,uom ,'EGS' as item_type ,qty ,rate ,0 as discount_amount,
